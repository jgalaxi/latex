...
\begin{figure}[h] 
    \centering
    \includegraphics[width=0.5\textwidth]{mapa de durezas.png} 
    \caption{Mapa de las durezas tomadas en la muestra} +
    \label{fig:durezas}
\end{figure}

En la \ref{fig:durezas} podemos ver todos los lugares en donde se hizo un ensayo de dureza Vickers. y las zona en la que se hizo la metalografia es: la zona 8 y la zona con el matel base es la 15 que utilizaremos como referencia.
