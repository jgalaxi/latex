...
\begin{abstract}
    ...
    \end{itemize}
\end{abstract}
\section{Calculo de fluencia y dureza con Hall-Petch.}
En este trabajo se estudia una muestra de una pieza la cual fue soldada sin precalentamiento por lo que se cree que la estructura de los materiales de la misma se vio afectada por el calor de la soldadura por lo que se le hizo una metalografia para analizar la microestructura de la misma. 
mas especificamente la parte del acero AISI 1020 y ver que cambios hubo en el mismo.
