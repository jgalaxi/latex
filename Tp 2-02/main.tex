...
En la \autoref{fig:durezas} podemos ver todos los lugares en donde se hizo un ensayo de dureza Vickers. y las zona en la que se hizo la metalografia es: la zona 8 y la zona con el matel base es la 15 que utilizaremos como referencia.
...
\begin{itemize}
    \item $HV$ = dureza despues del tratamiento termico.
    \item $HV_0$ = dureza despues del tratamiento termico.
    \item $k$ = constante del material.
    \item $d$ = diametro del grano.
\end{itemize}

remplazando $HV$ con la dureza de la zona 8 (zona afectada por el calor) y $HV_0$ con la dureza de la zona 15 (material base) y $d$ con el diametro de grano que obtuvimos se puede sacar $k$ y con esos se podria sacar la dureza del material en cualquier punto sabiendo el diametro del grano.
