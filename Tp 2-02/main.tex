...
\begin{equation}
    \sigma_0 = 1150\: \text{MPa} - 380,95\: \text{MPa}\cdot \mu m^{\frac{1}{2}}\cdot 0,75\: \mu m^{-\frac{1}{2}}
\end{equation}
...
\begin{equation}
    \sigma_y = 861,2\: \text{MPa} + 380,95\: \text{MPa}\cdot \mu \cdot m^{\frac{1}{2}} (116,84\: \mu m)^{-\frac{1}{2}}
\end{equation}
\begin{equation}
