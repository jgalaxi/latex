...
=======
Estos núcleos de hielo para poder formarse a temperaturas \textquotedblleft altas\textquotedblright (cerca de 0 °C) necesitan que hayan impurezas en el aire (nucleación heterogénea) que entren en contacto con las gotas de agua y estas impurezas permitan que se formen cristales de hielo, en cambio si el aire esta "limpio" los núcleos de hielo se formaran a temperaturas muy bajas (cerca de -40 °C, nucleacion homogenea). Si las impurezas en las que se forman los nucleos de hielo tienen la misma estructura cristalina del hielo (hexagonal) y unos parametros de red similares ($a=0,452 nm$ y $c=0,736 nm$) el hielo crecera mas facilmente en esas impurezas.\\Un ejemplo de este tipo de impurezas es el yoduro de plata que tambien posee una estructura cristalina hexagonal y sus parametros son a = 0,458 nm y c = 0,749 nm, lo que lo convierte en un buen material para provocar lluvia.

Más detalladamente, lo que ocurre en la nube al introducir el yoduro de plata es que las gotas de agua al entrar en contacto con el compuesto inorgánico empiezan a formar cristales de hielo que crecen hasta tener el tamaño suficiente y por gravedad caigan, y si esos cristales tienen forma de copo de nieve, se romperan al caer esparciendo cristales de hielo, que son el apoyo perfecto para formar nuevos nucleos de hielo y el proceso se repita una y otra vez, pero ahora sin la necesidad de impurezas de otros materiales.

Para hacer la simulacion nos vazamos en la ecuacion que marca la probabilidad de la caida de lluvia que es:
