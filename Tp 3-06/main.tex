...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[scale=0.7]{Figuras/Caldera.png}
        \caption{Esquema de la caldera}
        \label{fig:caldera}
    \end{subfigure}
    \hfill
    % Subfigura b
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[scale=0.7]{Figuras/caño.png}
        \caption{Esquema del caño}
        \label{fig:caño}
    \end{subfigure}
    % Caption general
    \caption{Esquemas de la caldera y del caño estudiado}
    \label{fig:esquemas}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Figuras/Figure_1.png}
    \caption{Tiempo a rotura en función de la temperatura para presiones, radios y espesores variables.}
\end{figure}
