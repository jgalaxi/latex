...
\begin{figure} [h!]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \subcaption{Esquema de la caldera.}
        \label{fig:caldera}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{Figuras/caño.png}
        \subcaption{Esquema de la tubería dañada.}
        \label{fig:tubo}
    \end{subfigure}
\end{figure}
...
\begin{itemize}
    ...
    \item $A$ = constante calibrada para cumplir que a \SI{900}{\celsius} y $\sigma=$ \SI{50}{\mega\pascal} $\rightarrow$ $t_r \approx$ \SI{15}{\minute}.
\end{itemize}
