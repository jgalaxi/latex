...
En el presente trabajo se realizaron ensayos sobre hilo de acero SAE/AISI 1045 de \SI{0,9}{\milli\metre} de diámetro para el ensayo de termofluencia; y \SI{0,6}{\milli\metre} para el ensayo de tracción y sobre alambre de aluminio AA 1305 h19 de \SI{1,85}{\milli\metre\diameter} (utilizado para ambos ensayos debido a que no se encontraron con alambres con secciones mas pequeñas). 
...
Siendo $d_1=$ \SI{450}{\milli\metre} y $d_2=$ \SI{150}{\milli\metre} por lo que nos quedaría la siguiente relación:
