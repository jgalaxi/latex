...
\begin{itemize}
    \item Un dinamómetro al equivalente de \SI{50}{\kilogram} de fuerza máxima (\SI{490,3325}{\newton}).
    \item Una regla para poder medir la deformación de la probeta.
    \item Un celular para grabar la deformación.
    \item Una amarraderas para sujetar la probeta y el dinamómetro.
    \item Y una máquina de tracción por palanca contruida especialmente para este ensayo.
\end{itemize}
...
Y esto se ve en la \autoref{eq:palanca}
...
Donde:
\begin{itemize}
    \item $F_1$ es la fuerza que se le está haciendo al dinamómetro.
    \item $F_2$ es la fuerza que se le está haciendo a la probeta.
    \item $d_1$ es la distancia del dinamómetro al punto de apoyo.
...
Siendo $d_1=$ \SI{900}{\milli\metre} y $d_2=$ \SI{350}{\milli\metre} por lo que nos quedaría la siguiente relación:
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.8\textwidth}
        \includegraphics[width=\textwidth]{Figuras/1045_traccion.png}
        \subcaption{Gráfica obtenida del ensayo de tracción del hilo de acero SAE/AISI 1045.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.8\textwidth}
        \includegraphics[width=\textwidth]{Figuras/Aluminio_traccion.png}
        \subcaption{Gráfica obtenida del ensayo de tracción del alambre de aluminio AA 1305 H19.}
    \end{subfigure}
    \caption{Gráficas obtenidas del ensayo de tracción.}
\end{figure}
